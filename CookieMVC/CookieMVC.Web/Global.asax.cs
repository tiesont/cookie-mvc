...
namespace CookieMVC.Web
{
    public class MvcApplication : System.Web.HttpApplication, Castle.Windsor.IContainerAccessor
    {
        ...
        private void BootstrapContainer()
        {
            ...
            GlobalConfiguration.Configuration.DependencyResolver = new WindsorHttpDependencyResolver(__container);
            GlobalConfiguration.Configuration.Services.Replace(typeof(IHttpControllerActivator), new WindsorHttpControllerActivator(__container));
        }
        ...
        protected void Application_Start()
        {
            ...
            SecurityConfig.ConfigureMvcSecurity();
        ...
        protected void Application_Error(object sender, EventArgs e)
        {
            ...
            IController errorsController = __container.Resolve<Controllers.ErrorController>();
